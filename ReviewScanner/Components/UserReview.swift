...
struct UserReview: View {
    ...
    var body: some View {
        Review(reviewTitle: reviewTitle, reviewBody: reviewBody, upperLeftLabel: upperLeftLabel, upperLeftValue: productName, shop: shop, price: price, rating: rating, mediaURLs: mediaURLs)
    }
}

#Preview {
    UserReview(reviewTitle: "Review title", reviewBody: "This is the text of the review", productName: "MacBook Pro", shop: "Shop1", price: 99.99, rating: 4, mediaURLs: [
