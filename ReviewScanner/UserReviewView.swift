...
struct UserReviewView: View {
    let upperLeftLabel: String = "Product"
    ...
    var body: some View {
        ReviewView(reviewTitle: reviewTitle, reviewBody: reviewBody, upperLeftLabel: upperLeftLabel, upperLeftValue: productName, shop: shop, price: price, rating: rating, mediaURLs: mediaURLs)
    }
}

#Preview {
    UserReviewView(reviewTitle: "Review title", reviewBody: "This is the text of the review", productName: "MacBook Pro", shop: "Shop1", price: "99.99", rating: 4, mediaURLs: [
